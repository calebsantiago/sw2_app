...
provider_schema.methods.encryptPassword = function (password) { return __awaiter(_this, void 0, void 0, function () {
    var salt, hash;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                salt = _a.sent();
                hash = bcryptjs_1.default.hash(password, salt);
                return [2 /*return*/, hash];
        }
    });
}); };
provider_schema.methods.matchPassword = function (password) {
